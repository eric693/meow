...
const ORG_KEYS = ['brand_name', 'staff_share_rate', 'gift_share_rate', 'vip_thresholds', 'vip_names',
  ...
  // BINGO（雨果幣）
  'bingo_min_bet', 'bingo_odds', 'bingo_symbols', 'bingo_animate', 'bingo_jackpot_limit',
  'bingo_bet_bonus', 'bingo_pity'];
...
const GUILD_KEYS = [
  ...
  // 語音房
  'channel_voice_hub', 'category_voice', 'voice_room_name', 'voice_room_private', 'voice_room_pool',
  // 下單選單選項（逗號分隔）
  ...
  // 技術單定級與陪玩身分組分流
  'order_rank_services', 'order_want_ranks', 'order_want_ranks_male', 'order_want_ranks_female', 'order_want_ranks_lol', 'order_rank_ladder', 'order_role_routes',
  // 結單頻道幾天後自動刪除
  'ticket_delete_days'
];
