...
const SEED = [
  ['大吉', '🎊', 'coupon', 100, 0, 500, 7, '雲收雨霽，星河為你讓路——今日所求，皆會應答。', 5, 0],
  ['中吉', '✨', 'coupon', 50, 0, 0, 7, '細雨潤物，好事正在來的路上，別急著關窗。', 12, 1],
  ['小吉', '🍀', 'coupon', 30, 0, 0, 7, '微風有信，今天適合主動說一句想說很久的話。', 18, 2],
  ['吉', '🌤️', 'coupon', 20, 0, 0, 7, '雲淡風輕，穩穩地走，該遇見的都在前面。', 20, 3],
